...
const content = [
  [
    ...
    "In React, you develop your applications by creating reusable components that you can think of as independent Lego blocks. These components are inidual pieces of a final interface, which, when assembled, form the applications entire user interface. "
  ],
  [
